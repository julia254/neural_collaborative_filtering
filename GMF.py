...
from tensorflow.keras.layers import Embedding, Flatten, Multiply, Reshape
...
def parse_args():
    ...
    parser.add_argument('--path', nargs='?', default='/content/neural_collaborative_filtering/Data/',
...
if __name__ == '__main__':
    ...
    model_out_file = "Pretrain/{}_GMF_{}_{}.weights.h5".format(args.dataset, num_factors, int(time()))
    ...
    for epoch in range(epochs):
        ...
        print(f"Epoch {epoch+1} done in {t2-t1:.2f}s")
